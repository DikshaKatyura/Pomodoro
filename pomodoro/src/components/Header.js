...
const Header = (props) => {
   ...
   const themeCtx = useContext(theme);
    ...
    return (
        <>
            <div className={`container-none flex justify-around p-4 text-white max-w-[480px] m-auto bg-${themeCtx.theme} rounded-b-lg mb-4`}>
                <div>
                    ...
                    <ul className="flex justify-evenly sm:gap-x-[8px] gap-x-4">
                        <li className="sm:mr-0">
                            ...
                            <Button className="flex align-center rounded pt-2 pb-2 pr-3 pl-3 min-w-[70px] sm:min-w-0 sm:pr-1 bg-[#ffffff1a] hover:bg-[#ffffff45]">
                                ...
                                fill='none' 
                                viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fff" className="w-5 h-5">
