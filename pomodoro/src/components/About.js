    ...
    <>
      <div className={classes.about} id="about">
        <div>
          ...
          <p>
            Kitchen Timer is a device whose primary function is to assist in
            timing during cooking.They are used keep a track of cooking over an
            extended period of time. It is a Web App based on a Time Management
            Technique known as{" "}
        ...
        <div>
          ...
          <p>
            ...
            breaks. Each Intervals is known as Pomodoro.
          </p>
        </div>
        <div>
